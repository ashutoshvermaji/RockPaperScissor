...
class Paper:
    ...
    def paper(self):
        ...
        strt_btn=Image.open("new/paper.jpg")
        ...
        b1_1=Button(self.root,text="PAPER",cursor="hand2",font=("times new roman",10),bg="white",fg="darkblue")
    ...
    def loop(self):
        try:
            ...
            if chk=="draw":
                ...
                title_lbl23=Label(self.root,text="you and computer both have selected the 'PAPER'?",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                ...
                # scissor has cut the paper
                title_lbl23=Label(self.root,text="scissor has cut your Paper",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                ...
                title_lbl23=Label(self.root,text="Paper has wrapped the computer's Rock?",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                title_lbl23.place(x=0,y=270,width=300 ,height=20)
