...
class Scissor:
    ...
    def scissor(self):
        ...
        strt_btn=Image.open("new/scissor.jpg")
        ...
        b1_1=Button(self.root,text="scissor",cursor="hand2",font=("times new roman",10),bg="white",fg="darkblue")
    ...
    def loop(self):
        try:
            ...
            if chk=="draw":
                ...
                title_lbl23=Label(self.root,text="you and computer both have selected the 'SCISSOR'?",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                ...
                # rock has crushed the your scissor
                title_lbl23=Label(self.root,text="Rock has chushed your scissor",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                title_lbl23.place(x=0,y=270,width=300 ,height=20)
                ...
                title_lbl23=Label(self.root,text="Scissor has cut the computer's Paper",font=("times new roman",13,"bold"),bg="white",fg='darkblue')
                title_lbl23.place(x=0,y=270,width=300 ,height=20)
